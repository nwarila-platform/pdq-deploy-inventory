...
Skeleton. The install spine is built one MS/PDQ-doc-grounded piece per strict-cycle cycle —
see [`_handoff/QUEUE.md`](../../../_handoff/QUEUE.md). `present_windows.yml` is currently a no-op
